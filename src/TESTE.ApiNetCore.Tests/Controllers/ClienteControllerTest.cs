...
using TESTE.ApiNetCore.Api.Controllers;
using TESTE.ApiNetCore.Application;
using TESTE.ApiNetCore.Application.Models;
using TESTE.ApiNetCore.Tests.Fixtures;
using TESTE.ApiNetCore.Tests.Mocks;
using System;
using System.Collections.Generic;
using System.Linq;
using Xunit;

namespace TESTE.ApiNetCore.Tests.Controllers
{
    [Collection("Mapper")]
